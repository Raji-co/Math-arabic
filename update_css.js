...
// Replace everything from SERLO EDITOR LTR OVERRIDES line down to the end of the file.
const startIndex = css.indexOf('/* =========================================================\n   SERLO EDITOR LTR OVERRIDES');
...
.serlo-editor-wrapper [data-qa="plugin-equations"] [data-qa="math-editor"] {
  direction: ltr !important;
  text-align: left !important;
  display: inline-block;
}

/* Specific fix for the Equations plugin layout */
.serlo-editor-wrapper [data-qa="plugin-equations"] table {
  width: 100%;
}
.serlo-editor-wrapper [data-qa="plugin-equations"] table tr {
  display: flexflex; /* default is table-row */
}
.serlo-editor-wrapper [data-qa="plugin-equations"] td {
